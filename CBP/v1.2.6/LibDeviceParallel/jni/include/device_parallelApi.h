...
// device_parallelApi_def.h : device Parallel API header file for the libDeviceParallel
//

#ifndef __DEVICE_PARALLELAPI_H__
#define __DEVICE_PARALLELAPI_H__
...
* 
* DESCRIPTION:
*     Initializes a device control to control (IN/OUT) GPIO's 
...
****************************************************************************************************
*/
int device_i2c_read (const int handle, const unsigned char dev_addr, const unsigned char *cmd, const int cmd_len, unsigned char *pBuffer, const int buffer_len);
...
****************************************************************************************************
*/
int device_i2c_write (const int handle, const unsigned char dev_addr, const unsigned char *cmd, const int cmd_len, const unsigned char *buffer, const int buffer_len);
...
****************************************************************************************************
*/
int device_spi_read (const int handle, const unsigned char *cmd, const int cmd_len, unsigned char *dummy, const int dummy_len, unsigned char *pBuffer, const int buffer_len, int *pLen_transferred, const int timeout);
...
****************************************************************************************************
*/
int device_spi_write (const int handle, const unsigned char *cmd, const int cmd_len, unsigned char *dummy, const int dummy_len, unsigned char *buffer, const int buffer_len, int *pLen_transferred, const int timeout);
...
#endif /* __DEVICE_PARALLELAPI_H__ */
