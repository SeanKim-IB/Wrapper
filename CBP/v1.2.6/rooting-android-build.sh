...
echo "################################################################################"
echo "#"
echo "# BUILD SCRIPT FOR ROOTED ANDROID IBScanUltimate SDK"
echo "#"
echo "################################################################################"
...
RELEASE_NAME=IBScanUltimate_Android_Rooting_$VERSION
...
cp -R "$REPO_FOLDER/Samples/Android/Rooting/SimpleScanSample"            "$TEMP_FOLDER/Samples/Android"
cp -a "$REPO_FOLDER/Samples/Android/Rooting/SimpleScanSample/.classpath" "$TEMP_FOLDER/Samples/Android/SimpleScanSample"
cp -a "$REPO_FOLDER/Samples/Android/Rooting/SimpleScanSample/.project"   "$TEMP_FOLDER/Samples/Android/SimpleScanSample"
