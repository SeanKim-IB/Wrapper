...
// For Kojak Algorithm
	...
	int				_Algo_Kojak_GetBrightWithRawImage_Rev1(BYTE *InRawImg, int *ForgraoundCNT, int *CenterX, int *CenterY, int *Bright);

// Analog TOF
#ifdef _KOJAK_ATOF_16B_
	BOOL			_Algo_Kojak_AutoCapture_CurrentSensor_and_ATOF(CaptureSetting *pSetting, int frameTime, int ImgSize, int *CaptureGood, int *pOperationMode);
#else
	BOOL			_Algo_Kojak_AutoCapture_CurrentSensor_and_ATOF(CaptureSetting *pSetting, int frameTime, int ImgSize, int *CaptureGood);
#endif
//////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#ifdef _KOJAK_ATOF_16B_
	int				_ConvertTOFtoVal(int DAC, int Current);

	int				m_DACThres;
	int				m_CurrentNormalized;
	int				m_CurrentNormalizedThreshold;
	int				m_AntiTingleMethod;
	int				m_TrueCount;
#endif
