...
#define __VID_DERMALOG__					(0x1FBA)
...
#define __PID_FIVE0_DERMALOG__				(0x0034)	// Dermalog (PID = 0x0034, VID = 0x1FBA)
...
#define __MAX_SUPPORTED_DEVICES_COUNT__		15
...
//#define _KOJAK_ATOF_16B_
#define __DUMMY_DETECT_FINGER_USING_ATOF__
...
#define _TARGET_MAX_BRIGHTNESS_FOR_CAPTURE2_	(80) //(70)
...
//////////////////////////////////////////////////////
// for Kojak 3.0
#define _KOJAK30_DAC_FOR_NORMAL_FINGER_WITH_TOF_	0xDF
#define _KOJAK30_DAC_FOR_MINIMUM_					0xDF
#define _KOJAK30_DAC_FOR_MAXIMUM_					0x20

#define _KOJAK30_NO_BIT_BITSHIFT_FOR_FULLFRAME_ROLL_	0
#define _KOJAK30_NO_BIT_CUTTHRES_FOR_FULLFRAME_ROLL_	5
#define _KOJAK30_DEFAULT_EXPOSURE_FOR_FULLFRAME_ROLL_	0x0BB8
#define _KOJAK30_NO_BIT_CMOS_NOISE_FOR_FULLFRAME_ROLL_	15
#define _KOJAK30_DEFAULT_ELON_FOR_FULLFRAME_ROLL_		0x48
#define _KOJAK30_PERIOD_ROLL_							0x88

#define _KOJAK30_NO_BIT_BITSHIFT_FOR_FULLFRAME_		1
#define _KOJAK30_NO_BIT_CUTTHRES_FOR_FULLFRAME_		15
#define _KOJAK30_NO_BIT_GAIN_FOR_FULLFRAME_			0x005F
#define _KOJAK30_NO_BIT_EXPOSURE_FOR_FULLFRAME_		0x0F08
#define _KOJAK30_NO_BIT_CMOS_NOISE_FOR_FULLFRAME_	20
#define _KOJAK30_DEFAULT_ELON_FOR_FULLFRAME_		0x38
#define _KOJAK30_PERIOD_FOR_FULLFRAME_				0x59

#define _KOJAK30_DEFAULT_BITSHIFT_FOR_DECI_			1//2
#define _KOJAK30_DEFAULT_CUTTHRES_FOR_DECI_			15//40
#define _KOJAK30_DEFAULT_GAIN_FOR_DECI_				0x005F
#define _KOJAK30_DEFAULT_EXPOSURE_FOR_DECI_			0x1350
#define _KOJAK30_DEFAULT_CMOS_NOISE_FOR_DECI_		20
#define _KOJAK30_DEFAULT_ELON_DECI_					0x70
#define _KOJAK30_PERIOD_DECI_						0x88

#define _KOJAK30_CS_MODE_BITSHIFT_FOR_FULLFRAME_	1
#define _KOJAK30_CS_MODE_CUTTHRES_FOR_FULLFRAME_	15
#define _KOJAK30_CS_MODE_GAIN_FOR_FULLFRAME_		0x005F
#define _KOJAK30_CS_MODE_EXPOSURE_FOR_FULLFRAME_	0x0DB8
#define _KOJAK30_CS_MODE_CMOS_NOISE_FOR_FULLFRAME_	20

#define _KOJAK30_CS_MODE_DEFAULT_BITSHIFT_FOR_DECI_	1//2
#define _KOJAK30_CS_MODE_DEFAULT_CUTTHRES_FOR_DECI_	15//40
#define _KOJAK30_CS_MODE_DEFAULT_GAIN_FOR_DECI_		0x005F
#define _KOJAK30_CS_MODE_DEFAULT_EXPOSURE_FOR_DECI_	0x1200
#define _KOJAK30_CS_MODE_DEFAULT_CMOS_NOISE_FOR_DECI_		20

#define _KOJAK30_ALWAYS_ELON_FOR_FULLFRAME_			0x20

#define _KOJAK30_BRIGHTNESS_THRES_FROM_AT_TO_CS		(25)
#define _KOJAK30_BRIGHTNESS_THRES_FROM_CS_TO_AT		(20)
//////////////////////////////////////////////////////
...
#define _FPGA_VER_FOR_KOJAK_3_0											( (3<<24) | (0<<16) | (0<<8) | (0) )	// Kojak 3.0
#define _FPGA_VER_FOR_KOJAK_3_0_WITH_DAIWON_AND_70VPP_					( (3<<24) | (1<<16) | (0<<8) | (0) )	// Kojak 3.0 + Daiwon lens + 70Vpp
...
// AES256 encryption
#define AES256_KEY_LENGTH			32		// 32 bytes
...
#else
#define pszLinuxFileVersion					"3.0.0.1"
#define pszLinuxProdutVersion				"3.0.0.1"
...
typedef struct tag_CaptureSetting
{
	...
	int Kojak30_PERIOD;			// for Kojak 3.0
	int Kojak30_ELON;			// for Kojak 3.0
}CaptureSetting;
...
typedef struct tag_KOJAK_CALIBRATION_INFO
{
	...
	char  cRequiredSDK[IBSU_MAX_STR_LEN];
	char ATOF_sign;
	short ATOF_Diff;
	short ATOF_slope;
	char ATOF_LEOFF_sign;
	short ATOF_LEOFF_Diff;
	short ATOF_LEOFF_slope;
}
...
typedef struct tagPropertyInfo
{
	...
	BOOL			bEnableViewEncryptionImage;
	BOOL			bEnableCBPMode;
} PropertyInfo;
...
#define CMD_EEPROM_WRITEPROTECTION	0xFA
