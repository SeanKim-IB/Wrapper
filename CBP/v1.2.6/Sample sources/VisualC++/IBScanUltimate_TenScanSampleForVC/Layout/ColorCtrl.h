...
BEGIN_TEMPLATE_MESSAGE_MAP(CColorCtrl, BASE_TYPE, BASE_TYPE)
	...
	ON_WM_DESTROY()
	//
	//    BFD - 11/6/12 - Remove this message for IBScanUltimate_TenScanSampleForVC (only breaks in 64 bit)
	// Error C2440: 'static_cast' : cannot convert from 'void (__cdecl CColorCtrl<BASE_TYPE>::* )(UINT)' to 'void (__cdecl CWnd::* )(UINT_PTR)'
	//
	//    ON_WM_TIMER()
	//
	ON_WM_CREATE()
