    ...
    void   *reserved)
{
    ...
    else
    {
        ...
        {
            MethodID_IBScan_DeviceDesc_DeviceDesc = getMethodID(pEnv, Class_IBScan_DeviceDesc, "<init>", "(L" STRING_CLASS_PATH ";L" STRING_CLASS_PATH ";L" STRING_CLASS_PATH ";L" STRING_CLASS_PATH ";L" STRING_CLASS_PATH ";Z)V", &ok);
        }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            devDescJ = (*pEnv)->NewObject(pEnv, Class_IBScan_DeviceDesc, MethodID_IBScan_DeviceDesc_DeviceDesc,
                                            serialNumber, productName, interfaceType, fwVersion, devRevision, isHandleOpened);
                            if (devDescJ == NULL)
                            {
                                setNativeError(pEnv, error, IBSU_ERR_MEM_ALLOC);
