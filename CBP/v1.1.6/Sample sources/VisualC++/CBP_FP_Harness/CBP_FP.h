...
struct cbp_fp_callBacks
{
	...
	void(*cbp_fp_onEnumDevices)(char *requestID, struct cbp_fp_device *deviceList[], int deviceListLen);
...
#define CBP_FP_PROPERTY_DPI							"dpi"						///< Indicates the DPI (dots per inch) supported by the scanner imaging.
