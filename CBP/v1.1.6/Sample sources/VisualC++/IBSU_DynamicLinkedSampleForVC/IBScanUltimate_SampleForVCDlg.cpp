...
pIBSU_OpenDevice			lpIBSU_OpenDevice;
pIBSU_OpenDeviceEx			lpIBSU_OpenDeviceEx;
pIBSU_CloseDevice			lpIBSU_CloseDevice;
pIBSU_GetSDKVersion			lpIBSU_GetSDKVersion;
pIBSU_GetDeviceCount		lpIBSU_GetDeviceCount;
pIBSU_GetDeviceDescription	lpIBSU_GetDeviceDescription;
pIBSU_RegisterCallbacks		lpIBSU_RegisterCallbacks;
pIBSU_GetProperty			lpIBSU_GetProperty;
pIBSU_ReleaseCallbacks		lpIBSU_ReleaseCallbacks;
pIBSU_SetLEDs				lpIBSU_SetLEDs;
pIBSU_SetProperty			lpIBSU_SetProperty;
pIBSU_BeginCaptureImage		lpIBSU_BeginCaptureImage;
pIBSU_IsCaptureActive		lpIBSU_IsCaptureActive;
pIBSU_CancelCaptureImage	lpIBSU_CancelCaptureImage;
pIBSU_UnloadLibrary		    lpIBSU_UnloadLibrary;
pIBSU_CreateClientWindow	lpIBSU_CreateClientWindow;
pIBSU_DestroyClientWindow	lpIBSU_DestroyClientWindow;
pIBSU_ModifyOverlayText		lpIBSU_ModifyOverlayText;
pIBSU_GetOperableBeeper		lpIBSU_GetOperableBeeper;
pIBSU_SetBeeper				lpIBSU_SetBeeper;
pIBSU_SaveBitmapImage		lpIBSU_SaveBitmapImage;
pIBSU_WSQEncodeToFile		lpIBSU_WSQEncodeToFile;
pIBSU_SavePngImage			lpIBSU_SavePngImage;
pIBSU_SaveJP2Image			lpIBSU_SaveJP2Image;
pIBSU_GetOperableLEDs		lpIBSU_GetOperableLEDs;
pIBSU_AddOverlayQuadrangle	lpIBSU_AddOverlayQuadrangle;
pIBSU_ModifyOverlayQuadrangle	lpIBSU_ModifyOverlayQuadrangle;
pIBSU_AddOverlayText		lpIBSU_AddOverlayText;
pIBSU_GetClientWindowProperty	lpIBSU_GetClientWindowProperty;
pIBSU_SetClientDisplayProperty	lpIBSU_SetClientDisplayProperty;
pIBSU_GetNFIQScore	lpIBSU_GetNFIQScore;
pIBSU_IsCaptureAvailable	lpIBSU_IsCaptureAvailable;
pIBSU_TakeResultImageManually	lpIBSU_TakeResultImageManually;
pIBSU_AsyncOpenDevice	lpIBSU_AsyncOpenDevice;
pIBSU_RedrawClientWindow	lpIBSU_RedrawClientWindow;
pIBSU_SetContrast	lpIBSU_SetContrast;
pIBSU_IsWritableDirectory	lpIBSU_IsWritableDirectory;
...
BOOL CIBScanUltimate_SampleForVCDlg::OnInitDialog()
{
	...
	lpIBSU_GetSDKVersion(&m_verInfo);
	CString titleName;
...
void CIBScanUltimate_SampleForVCDlg::InitializeLibrary()
{
	hDll=LoadLibrary("IBScanUltimate.dll"); 
	if(hDll == NULL)
	{
	...
	lpIBSU_OpenDevice=(pIBSU_OpenDevice)GetProcAddress(hDll,"IBSU_OpenDevice"); 
	lpIBSU_OpenDeviceEx=(pIBSU_OpenDeviceEx)GetProcAddress(hDll,"IBSU_OpenDeviceEx"); 
	lpIBSU_CloseDevice=(pIBSU_CloseDevice)GetProcAddress(hDll,"IBSU_CloseDevice"); 
	lpIBSU_GetSDKVersion=(pIBSU_GetSDKVersion)GetProcAddress(hDll,"IBSU_GetSDKVersion"); 
	lpIBSU_GetDeviceCount=(pIBSU_GetDeviceCount)GetProcAddress(hDll,"IBSU_GetDeviceCount"); 
	lpIBSU_GetDeviceDescription=(pIBSU_GetDeviceDescription)GetProcAddress(hDll,"IBSU_GetDeviceDescription"); 
	lpIBSU_RegisterCallbacks=(pIBSU_RegisterCallbacks)GetProcAddress(hDll,"IBSU_RegisterCallbacks"); 
	lpIBSU_GetProperty=(pIBSU_GetProperty)GetProcAddress(hDll,"IBSU_GetProperty"); 
	lpIBSU_ReleaseCallbacks=(pIBSU_ReleaseCallbacks)GetProcAddress(hDll,"IBSU_ReleaseCallbacks"); 
	lpIBSU_SetLEDs=(pIBSU_SetLEDs)GetProcAddress(hDll,"IBSU_SetLEDs"); 
	lpIBSU_SetProperty=(pIBSU_SetProperty)GetProcAddress(hDll,"IBSU_SetProperty"); 
	lpIBSU_BeginCaptureImage=(pIBSU_BeginCaptureImage)GetProcAddress(hDll,"IBSU_BeginCaptureImage"); 
	lpIBSU_IsCaptureActive=(pIBSU_IsCaptureActive)GetProcAddress(hDll,"IBSU_IsCaptureActive"); 
	lpIBSU_CancelCaptureImage=(pIBSU_CancelCaptureImage)GetProcAddress(hDll,"IBSU_CancelCaptureImage"); 
	lpIBSU_UnloadLibrary=(pIBSU_UnloadLibrary)GetProcAddress(hDll,"IBSU_UnloadLibrary"); 
	lpIBSU_CreateClientWindow=(pIBSU_CreateClientWindow)GetProcAddress(hDll,"IBSU_CreateClientWindow"); 
	lpIBSU_DestroyClientWindow=(pIBSU_DestroyClientWindow)GetProcAddress(hDll,"IBSU_DestroyClientWindow"); 
	lpIBSU_ModifyOverlayText=(pIBSU_ModifyOverlayText)GetProcAddress(hDll,"IBSU_ModifyOverlayText"); 
	lpIBSU_GetOperableBeeper=(pIBSU_GetOperableBeeper)GetProcAddress(hDll,"IBSU_GetOperableBeeper"); 
	lpIBSU_SetBeeper=(pIBSU_SetBeeper)GetProcAddress(hDll,"IBSU_SetBeeper"); 
	lpIBSU_SaveBitmapImage=(pIBSU_SaveBitmapImage)GetProcAddress(hDll,"IBSU_SaveBitmapImage"); 
	lpIBSU_WSQEncodeToFile=(pIBSU_WSQEncodeToFile)GetProcAddress(hDll,"IBSU_WSQEncodeToFile"); 
	lpIBSU_SavePngImage=(pIBSU_SavePngImage)GetProcAddress(hDll,"IBSU_SavePngImage"); 
	lpIBSU_SaveJP2Image=(pIBSU_SaveJP2Image)GetProcAddress(hDll,"IBSU_SaveJP2Image"); 
	lpIBSU_GetOperableLEDs=(pIBSU_GetOperableLEDs)GetProcAddress(hDll,"IBSU_GetOperableLEDs"); 
	lpIBSU_AddOverlayQuadrangle=(pIBSU_AddOverlayQuadrangle)GetProcAddress(hDll,"IBSU_AddOverlayQuadrangle"); 
	lpIBSU_ModifyOverlayQuadrangle=(pIBSU_ModifyOverlayQuadrangle)GetProcAddress(hDll,"IBSU_ModifyOverlayQuadrangle"); 
	lpIBSU_AddOverlayText=(pIBSU_AddOverlayText)GetProcAddress(hDll,"IBSU_AddOverlayText"); 
	lpIBSU_GetClientWindowProperty=(pIBSU_GetClientWindowProperty)GetProcAddress(hDll,"IBSU_GetClientWindowProperty"); 
	lpIBSU_SetClientDisplayProperty=(pIBSU_SetClientDisplayProperty)GetProcAddress(hDll,"IBSU_SetClientDisplayProperty"); 
	lpIBSU_GetNFIQScore=(pIBSU_GetNFIQScore)GetProcAddress(hDll,"IBSU_GetNFIQScore"); 
	lpIBSU_IsCaptureAvailable=(pIBSU_IsCaptureAvailable)GetProcAddress(hDll,"IBSU_IsCaptureAvailable"); 
	lpIBSU_TakeResultImageManually=(pIBSU_TakeResultImageManually)GetProcAddress(hDll,"IBSU_TakeResultImageManually"); 
	lpIBSU_AsyncOpenDevice=(pIBSU_AsyncOpenDevice)GetProcAddress(hDll,"IBSU_AsyncOpenDevice"); 
	lpIBSU_RedrawClientWindow=(pIBSU_RedrawClientWindow)GetProcAddress(hDll,"IBSU_RedrawClientWindow"); 
	lpIBSU_SetContrast=(pIBSU_SetContrast)GetProcAddress(hDll,"IBSU_SetContrast");
	lpIBSU_IsWritableDirectory=(pIBSU_IsWritableDirectory)GetProcAddress(hDll,"IBSU_IsWritableDirectory");

	lpIBSU_RegisterCallbacks( NULL, ENUM_IBSU_ESSENTIAL_EVENT_DEVICE_COUNT, OnEvent_DeviceCount, this );
	lpIBSU_RegisterCallbacks( NULL, ENUM_IBSU_ESSENTIAL_EVENT_INIT_PROGRESS, OnEvent_InitProgress, this );
	lpIBSU_RegisterCallbacks( NULL, ENUM_IBSU_ESSENTIAL_EVENT_ASYNC_OPEN_DEVICE, OnEvent_AsyncOpenDevice, this );
}
...
{   
	...
	if( pDlg->m_chkOpenDeviceEx )
	{
		...
		nRc = lpIBSU_OpenDeviceEx( devIndex, unformityMaskPath, FALSE, &devHandle );
	}
	else
	{
		nRc = lpIBSU_OpenDevice( devIndex, &devHandle );
	}
...
void CIBScanUltimate_SampleForVCDlg::_SetImageMessage( LPCSTR Format, ... )
{
	...
	lpIBSU_ModifyOverlayText( m_nDevHandle, m_nOvImageTextHandle, "Arial", font_size, TRUE/*bold*/, cMessage, x, y, (DWORD)cr );
}
...
void CIBScanUltimate_SampleForVCDlg::_UpdateCaptureSequences()
{
	...
	if( devIndex > -1 )
		lpIBSU_GetDeviceDescription( devIndex, &devDesc );
...
int CIBScanUltimate_SampleForVCDlg::_ReleaseDevice()
{
	...
	if( m_nDevHandle != -1 )
	{
		nRc = lpIBSU_CloseDevice( m_nDevHandle );
		TRACE("call lpIBSU_UnloadLibrary\n");
		lpIBSU_UnloadLibrary();

		TRACE("call FreeLibrary\n");
		FreeLibrary(hDll);
		hDll = NULL;

		TRACE("call InitializeLibrary\n");
		InitializeLibrary();
	}
...
void CIBScanUltimate_SampleForVCDlg::_BeepFail()
{
    ...
    if (lpIBSU_GetOperableBeeper(m_nDevHandle, &beeperType) != IBSU_STATUS_OK)
    {
	    Beep( 3500, 300 );
	    Sleep(150);
	    Beep( 3500, 150 );
    ...
    {
   	    lpIBSU_SetBeeper(m_nDevHandle, ENUM_IBSU_BEEP_PATTERN_GENERIC, 2/*Sol*/, 12/*300ms = 12*25ms*/, 0, 0);
	    Sleep(150);
   	    lpIBSU_SetBeeper(m_nDevHandle, ENUM_IBSU_BEEP_PATTERN_GENERIC, 2/*Sol*/, 6/*150ms = 6*25ms*/, 0, 0);
	    Sleep(150);
   	    lpIBSU_SetBeeper(m_nDevHandle, ENUM_IBSU_BEEP_PATTERN_GENERIC, 2/*Sol*/, 6/*150ms = 6*25ms*/, 0, 0);
	    Sleep(150);
   	    lpIBSU_SetBeeper(m_nDevHandle, ENUM_IBSU_BEEP_PATTERN_GENERIC, 2/*Sol*/, 6/*150ms = 6*25ms*/, 0, 0);
...
void CIBScanUltimate_SampleForVCDlg::_BeepSuccess()
{
    ...
    {
   	    lpIBSU_SetBeeper(m_nDevHandle, ENUM_IBSU_BEEP_PATTERN_GENERIC, 2/*Sol*/, 4/*100ms = 4*25ms*/, 0, 0);
	    Sleep(150);
   	    lpIBSU_SetBeeper(m_nDevHandle, ENUM_IBSU_BEEP_PATTERN_GENERIC, 2/*Sol*/, 4/*100ms = 4*25ms*/, 0, 0);
    }
}
...
//	CaptureInfo info = m_vecCaptureSeq[m_nCurrentCaptureStep];
	...
	if( lpIBSU_SaveBitmapImage( strFileName, (BYTE*)image.Buffer, 
...
void CIBScanUltimate_SampleForVCDlg::_SaveWsqImage( const IBSU_ImageData &image, const CString &fingerName ) 
{
	...
	if( lpIBSU_WSQEncodeToFile( strFileName, (BYTE*)image.Buffer,
...
//	CaptureInfo info = m_vecCaptureSeq[m_nCurrentCaptureStep];
	...
	if( lpIBSU_SavePngImage( strFileName, (BYTE*)image.Buffer, 
						   image.Width, image.Height, image.Pitch, 
						   image.ResolutionX, image.ResolutionY ) != IBSU_STATUS_OK )
	{
...
//	CaptureInfo info = m_vecCaptureSeq[m_nCurrentCaptureStep];
	...
	if( lpIBSU_SaveJP2Image( strFileName, (BYTE*)image.Buffer, 
						   image.Width, image.Height, image.Pitch, 
...
int CIBScanUltimate_SampleForVCDlg::_ExecuteInitializeDevice(int nRc, int devHandle)
{
	...
	if( nRc >= IBSU_STATUS_OK )
	{
        ...
        lpIBSU_GetOperableLEDs(devHandle, &m_LedType, &ledCount, &operableLEDs);
...
*/
		...
		lpIBSU_CreateClientWindow( devHandle, disWnd->m_hWnd, clientRect.left, clientRect.top, clientRect.right, clientRect.bottom );

		lpIBSU_AddOverlayQuadrangle(m_nDevHandle, &m_nOvClearPlatenHandle, 0, 0, 0, 0, 0, 0, 0, 0, 0, (DWORD)0);
		lpIBSU_AddOverlayText(m_nDevHandle, &m_nOvImageTextHandle, "Arial", 10, TRUE/*bold*/, "", 10, 10, (DWORD)0);
		for( int i=0; i<IBSU_MAX_SEGMENT_COUNT; i++ )
			lpIBSU_AddOverlayQuadrangle(m_nDevHandle, &m_nOvSegmentHandle[i], 0, 0, 0, 0, 0, 0, 0, 0, 0, (DWORD)0);
...
*/
		...
		lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_ESSENTIAL_EVENT_COMMUNICATION_BREAK, OnEvent_DeviceCommunicationBreak, this );    
		lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_ESSENTIAL_EVENT_PREVIEW_IMAGE, OnEvent_PreviewImage, this );
		lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_ESSENTIAL_EVENT_TAKING_ACQUISITION, OnEvent_TakingAcquisition, this );  
		lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_ESSENTIAL_EVENT_COMPLETE_ACQUISITION, OnEvent_CompleteAcquisition, this );  
        lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_ESSENTIAL_EVENT_RESULT_IMAGE_EX, OnEvent_ResultImageEx, this );  
		lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_OPTIONAL_EVENT_FINGER_COUNT, OnEvent_FingerCount, this );  
		lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_OPTIONAL_EVENT_FINGER_QUALITY, OnEvent_FingerQuality, this );  
		if( m_chkUseClearPlaten )
			lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_OPTIONAL_EVENT_CLEAR_PLATEN_AT_CAPTURE, OnEvent_ClearPlatenAtCapture, this );  
		lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_OPTIONAL_EVENT_NOTIFY_MESSAGE, OnEvent_NotifyMessage, this );  
		lpIBSU_RegisterCallbacks( devHandle, ENUM_IBSU_ESSENTIAL_EVENT_KEYBUTTON, OnEvent_PressedKeyButtons, this );
	}
...
int CIBScanUltimate_SampleForVCDlg::_ModifyOverlayForWarningOfClearPlaten(BOOL bVisible)
{
    ...
    if( bVisible )
	{
		nRc = lpIBSU_ModifyOverlayQuadrangle(m_nDevHandle, m_nOvClearPlatenHandle,
...
void CIBScanUltimate_SampleForVCDlg::_SetLEDs(int deviceHandle, CaptureInfo info, int ledColor, BOOL bBlink)
{
    ...
    if (m_LedType == ENUM_IBSU_LED_TYPE_FSCAN)
    {
	    ...
	    lpIBSU_SetLEDs(deviceHandle, setLEDs);
    }
}
					   ...
					   )
{
	...
	else
	{
		...
		lpIBSU_RedrawClientWindow(deviceHandle); 
	}
...
//    IBSU_SetBeeper(deviceHandle, ENUM_IBSU_BEEP_PATTERN_REPEAT, 2/*Sol*/, 3/*75ms = 3*25ms*/, 4/*100ms = 4*25ms*/, 0 /*stop*/);
    ...
    if( imageStatus >= IBSU_STATUS_OK )
    {
		...
		if( pDlg->m_chkDrawSegmentImage )
		{
			...
			lpIBSU_GetClientWindowProperty(deviceHandle, ENUM_IBSU_WINDOW_PROPERTY_SCALE_FACTOR, propertyValue);
			double scaleFactor = atof(propertyValue);
			lpIBSU_GetClientWindowProperty(deviceHandle, ENUM_IBSU_WINDOW_PROPERTY_LEFT_MARGIN, propertyValue);
			int leftMargin = atoi(propertyValue);
			lpIBSU_GetClientWindowProperty(deviceHandle, ENUM_IBSU_WINDOW_PROPERTY_TOP_MARGIN, propertyValue);
			...
			for( int i=0; i<segmentImageArrayCount; i++ )
			{
				...
				lpIBSU_ModifyOverlayQuadrangle(deviceHandle, pDlg->m_nOvSegmentHandle[i],
...
*/
	    ...
	    if( pDlg->m_chkUseNFIQ )
	    {
			...
			for( int i=0; i<IBSU_MAX_SEGMENT_COUNT; i++ )
			{
				...
				nRc = lpIBSU_GetNFIQScore(deviceHandle, (const BYTE*)(pSegmentImageArray+segment_pos)->Buffer,
						  ...
						  )
{
    ...
    if( pressedKeyButtons == __LEFT_KEY_BUTTON__ )
    {
        if (selectedDev && idle)
        {
        	lpIBSU_SetBeeper(deviceHandle, ENUM_IBSU_BEEP_PATTERN_GENERIC, 2/*Sol*/, 4/*100ms = 4*25ms*/, 0, 0);
...
*/
	...
	{
		lpIBSU_SetProperty(m_nDevHandle, ENUM_IBSU_PROPERTY_SUPER_DRY_MODE, "TRUE");
	}
	else
	{
		lpIBSU_SetProperty(m_nDevHandle, ENUM_IBSU_PROPERTY_SUPER_DRY_MODE, "FALSE");
	}
...
LRESULT CIBScanUltimate_SampleForVCDlg::OnMsg_CaptureSeqNext(WPARAM wParam, LPARAM lParam)
{
	...
	if( m_chkInvalidArea )
	{
		lpIBSU_SetClientDisplayProperty(m_nDevHandle, ENUM_IBSU_WINDOW_PROPERTY_DISP_INVALID_AREA, "TRUE");
	}
	else
	{
		lpIBSU_SetClientDisplayProperty(m_nDevHandle, ENUM_IBSU_WINDOW_PROPERTY_DISP_INVALID_AREA, "FALSE");
	}

	if( m_chkDetectSmear )
	{
		lpIBSU_SetProperty(m_nDevHandle, ENUM_IBSU_PROPERTY_ROLL_MODE, "1");
		CString strValue;
		strValue.Format("%d", m_cboSmearLevel.GetCurSel());
		lpIBSU_SetProperty(m_nDevHandle, ENUM_IBSU_PROPERTY_ROLL_LEVEL, strValue);
	}
	else
	{
		lpIBSU_SetProperty(m_nDevHandle, ENUM_IBSU_PROPERTY_ROLL_MODE, "0");
	}

	for( int i=0; i<IBSU_MAX_SEGMENT_COUNT; i++ )
		lpIBSU_ModifyOverlayQuadrangle(m_nDevHandle, m_nOvSegmentHandle[i], 0, 0, 0, 0, 0, 0, 0, 0, 0, (DWORD)0);
	...
	nRc = lpIBSU_IsCaptureAvailable(m_nDevHandle, info.ImageType, imgRes, &bAvailable);
	...
	nRc = lpIBSU_BeginCaptureImage(m_nDevHandle, info.ImageType, imgRes, captureOptions);
	if( nRc >= IBSU_STATUS_OK )
	{
...
LRESULT CIBScanUltimate_SampleForVCDlg::OnMsg_UpdateDeviceList(WPARAM wParam, LPARAM lParam)
{
	...
	// populate combo box
	int devices = 0;
	lpIBSU_GetDeviceCount( &devices );

	selectedDev = 0;
	for( int i = 0; i < devices; i++ )
	{
		IBSU_DeviceDesc devDesc;
		if( lpIBSU_GetDeviceDescription( i, &devDesc ) < IBSU_STATUS_OK )
			continue;
...
void CIBScanUltimate_SampleForVCDlg::OnBnClickedBtnCaptureStart()
{
	...
	if( m_nCurrentCaptureStep != -1 )
	{
		BOOL IsActive;
		int nRc;
		nRc = lpIBSU_IsCaptureActive(m_nDevHandle, &IsActive);
		if( nRc == IBSU_STATUS_OK && IsActive )
		{
			lpIBSU_TakeResultImageManually(m_nDevHandle);
		}
...
//		InitializeLibrary();
		...
		if( m_chkAsyncOpenDevice )
		{
			...
			if( m_chkOpenDeviceEx )
            {
	            TCHAR	unformityMaskPath[MAX_PATH + 1];				///< Base folder for uniformity mask path
	            SHGetSpecialFolderPath( NULL, unformityMaskPath, CSIDL_MYPICTURES, TRUE );
				nRc = lpIBSU_OpenDeviceEx( devIndex, unformityMaskPath, TRUE, &tmpDevHandle/* Always vaule is "-1" when async mode"*/ );
            }
			else
				nRc = lpIBSU_AsyncOpenDevice( devIndex );
...
void CIBScanUltimate_SampleForVCDlg::OnBnClickedBtnCaptureStop()
{
	...
	lpIBSU_CancelCaptureImage( m_nDevHandle );
    CaptureInfo tmpInfo;
	_SetLEDs(m_nDevHandle, tmpInfo, __LED_COLOR_NONE__, FALSE);
	m_nCurrentCaptureStep = -1;
	m_bNeedClearPlaten = FALSE;
...
void CIBScanUltimate_SampleForVCDlg::OnBnClickedBtnImageFolder()
{
	...
	if(lpIBSU_IsWritableDirectory(m_ImgSaveFolder, TRUE) != IBSU_STATUS_OK)
	{
...
void CIBScanUltimate_SampleForVCDlg::OnNMReleasedcaptureSliderContrast(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	lpIBSU_SetContrast(m_nDevHandle, pos);
...
*/
		...
		lpIBSU_DestroyClientWindow( m_nDevHandle, FALSE );
		lpIBSU_CreateClientWindow( m_nDevHandle, disWnd->m_hWnd, clientRect.left, clientRect.top, clientRect.right, clientRect.bottom );
	}
}
