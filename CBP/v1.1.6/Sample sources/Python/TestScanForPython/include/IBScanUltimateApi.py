...
IBSU_AddFingerImage.argtypes = (c_int, IBSU_ImageData, c_uint, IBSU_ImageType, c_bool)
...
IBSU_IsFingerDuplicated.argtypes = (c_int, IBSU_ImageData, c_uint, IBSU_ImageType, c_int, POINTER(c_uint))
...
IBSU_IsValidFingerGeometry.argtypes = (c_int, IBSU_ImageData, c_uint, IBSU_ImageType, POINTER(c_bool))
