 ...
 *
 * NOTES:
 *     Copyright (c) Integrated Biometrics, 2012-2014
 *     
 * HISTORY:
 ...
 *     2015/03/16  Updated for IBScanUltimate v1.8.3.1.
...
int main(int argc, char* argv[])
{
    ...
    /* To terminate the library explicitly */
    IBSU_UnloadLibrary();
}
