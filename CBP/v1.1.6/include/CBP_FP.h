...
#define CBP_FP_WARNING								1	///< a warning. Vendor warnings are normalized to CBP_FP_WARNING.
#define CBP_FP_ERROR								2	///< a general error has occurred and no details are available.
#define CBP_FP_ERROR_NOT_IMPLEMENTED				3	///< the function has not been implimented.  Some functions are not mandatory and this code is used to indicate that they are optional.
#define CBP_FP_ERROR_NOT_OPENED						4	///< the handle referencing a connection to the ten print scanner is not open.
#define CBP_FP_ERROR_INVALID_HANDLE					5	///< the handle referencing a connection to the ten print scanner is no longer valid.
#define CBP_FP_ERROR_SCANNER_NOT_FOUND				6	///< the scanner indicated has not been found 
#define CBP_FP_ERROR_INVALID_SCANNER_SERIAL_NUMBER	7	///< the scanner serial number is invalid
#define CBP_FP_ERROR_INVALID_SCANNER_NAME			8	///< a scanner name is improperly formatted or not found.
#define CBP_FP_ERROR_ALREADY_LOCKED					9	///< the connected scanner is already locked.
#define CBP_FP_ERROR_NOT_LOCKED						10	///< the connected scanner is not locked.
#define CBP_FP_ERROR_IO_ERROR						11	///< the connected scanner experienced an IO error.
#define CBP_FP_ERROR_UNSUPPORTED_SLAP				12	///< an unsupported slap has been requested in \c struct \c cbp_fp_callBacks.cbp_fp_startImaging.
#define CBP_FP_ERROR_BUSY							13	///< the connected scanner is busy.
#define CBP_FP_ERROR_NOT_INITIALIZED				14	///< the library is not initialized.
#define CBP_FP_ERROR_NOT_CLOSED						15	///< the scanner is not closed.
#define CBP_FP_ERROR_CALLBACK_REGISTRATION			16	///< an error occurred during the call back registration.
#define CBP_FP_ERROR_CAPTURE						17	///< an error occurred during a capture of a slap.
#define CBP_FP_ERROR_IMAGING						18	///< an error occurred during a imaging of a slap.
#define CBP_FP_ERROR_PROPERTY_NOT_SETABLE			19	///< the property is not setable in \c cbp_fp_setProperty call.
#define CBP_FP_ERROR_LOCK							20	///< an error occurred during a \c cbp_fp_lock call.
#define CBP_FP_ERROR_UNLOCK							21	///< an error occurred during a \c cbp_fp_unLock call.
#define CBP_FP_ERROR_PROPERTY						22	///< an error occurred during a \c cbp_fp_getProperty call.
#define CBP_FP_ERROR_CALIBRATE						23	///< an error occurred during the calibrate.
#define CBP_FP_ERROR_UNITIALIZE						24	///< an error occurred during unitialization.
#define CBP_FP_ERROR_NOT_CONNECTED					25	///< the scanner is disconnected
#define CBP_FP_ERROR_CONFIGURE						26	///< an error occurred during configuration
#define CBP_FP_ERROR_GET_DIRTINESS					27	///< an error occurred when checking for dirtiness
#define CBP_FP_ERROR_POWER_SAVE						28	///< an error occurred during power save
// use defined
//#define CBP_FP_ERROR_ALREADY_INITIALIZED			100	///< the scanner is capturing already.
#define CBP_FP_WRN_ALREADY_INITIALIZED				100	///< the scanner is capturing already.
#define CBP_FP_ERROR_ALREADY_CAPTURING				101	///< the scanner is capturing already.
#define CBP_FP_ERROR_NOT_CAPTURING					102 ///< the scanner is not capturing.
#define CBP_FP_ERROR_NOW_CAPTURING					103 ///< the scanner is capturing now.
#define CBP_FP_ERROR_INVALID_PARAM					104	///< the param is not valid.
#define CBP_FP_ERROR_PREVIEW						105	///< an error occurred during preview or previewanalysis.
#define CBP_FP_ERROR_UNSUPPORTED_COLLECTION_TYPE	106	///< an unsupported collection type has been requested in \c struct \c cbp_fp_callBacks.cbp_fp_startImaging.
