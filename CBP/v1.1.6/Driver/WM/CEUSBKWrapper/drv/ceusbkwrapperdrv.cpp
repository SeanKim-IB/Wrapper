...
DBGPARAM dpCurSettings = {
	TEXT("ceusbkwrapperdrv"), {
		...
		TEXT("OpenContext"),TEXT("BufferMapping"),
		TEXT("Undefined"),TEXT("Undefined"),
		TEXT("Undefined"),TEXT("Undefined"),
		TEXT("Undefined"),TEXT("Undefined") },
	DBG_ERROR | DBG_WARNING | DBG_DISCOVERY 
//	| DBG_IFACEFILTER   // TODO: Remove these
//	| DBG_ENTRYPOINT | DBG_FUNCTION | DBG_DEVLIFETIME | DBG_TRANSFERLIFETIME
//	| DBG_OPENCONTEXT | DBG_BUFFERMAPPING | DBG_DUMPBUFFER
};
  ...
  PDWORD pdwActualOut)
{
	...
	FUNCTION_MSG((
		TEXT("USBKWrapperDrv!Exit IOControl returning %s\r\n"), ret ? TEXT("True") : TEXT("False"))); 
