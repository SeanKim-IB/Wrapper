...
CC           = gcc
STRIP        = strip
INCLUDES     = -include CaptureLib/gcc_preinclude.h -I ../include -I . -I CaptureLib -I ThreadLib -I MatcherLib -I CxImage_Libs/include
WARNINGS     = -Wall
OPTIMIZATION = -O2
...
FLAGSAR      = -fPIC $(ARCHFLAGS) -Wl,--no-as-needed -shared -lusb -lpthread -lstdc++ -Wl,--version-script=IBScanUltimate.vsc
...
$(LIBDIR)/libIBScanUltimate.so: $(OBJS) $(CAPTUREOBJS) $(THREADOBJS) $(MATCHEROBJS) | $(LIBDIR)
	$(CC) $(OPTIMIZATION) $(INCLUDES) $(FLAGSAR) -o $@ $^ $(LIBRARIES)
	$(STRIP) -o $@.stripped $@
$(LIBDIR):
	mkdir $(LIBDIR)
