...
public:	// Implementation:
	...
	int				Reserved_GetCBPPreviewInfo(IBSU_SegmentPosition *segmentPositionArray, IBSU_SegmentPosition *segmentPositionArray_for_geo, int *segmentPositionArrayCount, BOOL *IsFingerDetected);
	int				Reserved_CleanUpCBP();
...
//	BOOL			_GetDeviceNameByIndex(LPGUID pGuid, DWORD dwDeviceNumber, char *outNameBuf);
	...
	int 			_InitializeForCISRegister(WORD rowStart, WORD colStart, WORD width, WORD height);
