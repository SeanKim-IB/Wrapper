...
CROSS_COMPILE_arm_linux_rpi_gnueabihf=~/Toolchain/Linaro/raspberry/gcc-4.7-linaro-rpi-gnueabihf/bin/arm-linux-gnueabihf-

REMOVE_arm_linux_gnueabi=no
REMOVE_arm_linux_gnueabihf=no
REMOVE_arm_linux_rpi_gnueabihf=yes

ABIS=(arm-linux-gnueabi arm-linux-gnueabihf arm-linux-rpi-gnueabihf)
...
tar --exclude-vcs -cvpzf $PKG_RPI".tgz" $OUTFOLDER
