...
void CIBAlgorithm::_Algo_Columbo_Init_Distortion_Merge_with_Bilinear()
{
	...
	int cut_width = 112 + m_PPI_Correction_Horizontal; //넚이와 높이가 4:5 비율이니 컷팅 비율도 4:5로 줄여야 한다. 
    int cut_height = 142 + m_PPI_Correction_Vertical;// 즉 컷팅되는 비율이 4:5 여야 한다. (가로 10을 짤랐으면 세로는 12.5)
