...
LOCAL_CFLAGS += -D__linux__ -D__embedded__ -D__android__ -D_STLP_USE_NEWALLOC -fexceptions \
	-W -Wall
...
LOCAL_C_INCLUDES             := $(LOCAL_PATH)/. $(LOCAL_PATH)/../include $(LOCAL_PATH)/CaptureLib $(LOCAL_PATH)/ThreadPool $(LOCAL_PATH)/MatcherLib "$(LOCAL_PATH)/../Samples/Android/LibUsb/jni/libusb/compat" $(LOCAL_PATH)/CxImage_Libs/include
