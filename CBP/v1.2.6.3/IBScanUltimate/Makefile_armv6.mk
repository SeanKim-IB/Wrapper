...
ifeq ($(ARCHABI),arm-linux-gnueabihf)
	ARCHFLAGS = -fexceptions -mfloat-abi=hard -march=armv6 -marm 
	...
	ifeq ($(ARCHABI),arm-linux-gnueabi)
		ARCHFLAGS = -fexceptions -mfloat-abi=soft -mthumb -march=armv6 -mtls-dialect=gnu
...
DEFINES      = -DBSD -D__linux__ -D_MULTI_THREADED $(ARCHDEFINES) -fexceptions
