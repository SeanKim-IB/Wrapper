...
const QColor IBSU_SampleForQT::s_brushPlaten(78,78,78);
    ...
    ui(new Ui::IBSU_SampleForQT)
{
	...
	strDrawString.sprintf("<html><head/><body><p><span style=' font-size:14pt; color:#ffffff;'>QT sample with DLL ver. %s</span></p></body></html>", m_verInfo.Product);
...
int IBSU_SampleForQT::_WaitingForFinishInitDevice(const int devIndex)
{
    ...
    else
    {
        ...
        case IBSU_ERR_USB20_REQUIRED:
            ...
            break;
        default:
			strMessage.sprintf("[Error code = %d] Device initialization failed", nRc);
            break;
        }
    }
    ...
    if(m_nDevHandle == -1)
    {
        ...
        else
        {
			...
			case IBSU_ERR_USB20_REQUIRED:
				...
				break;
			default:
				_SetStatusBarMessage("[Error code = %d] Device initialization failed", nRc);
				break;
			}
        }
    }
