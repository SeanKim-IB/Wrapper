	...
	)
{
	...
	if(RESERVED_CBP_GetPreviewInfo(deviceHandle, "ibkorea1120!", pDlg->m_segmentPositionArray, pDlg->m_segmentPositionArray_for_geo, &pDlg->m_segmentPositionArrayCount, &pDlg->m_IsFingerDetected) == IBSU_STATUS_OK)
	{
