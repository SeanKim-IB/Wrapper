...
*/
	...
	static UINT _threadAgingTest(LPVOID pParam);
	int m_nAgingTest;
	int m_TOTAL_CNT;
	int m_SUCCESS_CNT;
private:
...
public:
	...
	BOOL m_chkUseStartVpp;
	CSliderCtrl m_sliderVoltage;
	CSliderCtrl m_sliderWetLevel;
	afx_msg void OnNMCustomdrawSliderStartingVoltage(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnNMReleasedcaptureSliderStartingVoltage(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnBnClickedCheckEnableStartingVoltage();
	afx_msg void OnEnChangeEditStartingVoltage2();
	CString m_strSharpVal;
	afx_msg void OnNMCustomdrawSliderWetDetectLevel(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnNMReleasedcaptureSliderWetDetectLevel(NMHDR *pNMHDR, LRESULT *pResult);
	afx_msg void OnBnClickedRadioTofOn();
	afx_msg void OnBnClickedRadioTofOff();
	afx_msg void OnBnClickedRadioTofOnRoll();
	afx_msg void OnBnClickedRadioTofOffRoll();
	afx_msg void OnBnClickedButtonAgingTest();
	afx_msg void OnBnClickedButtonGetFinalImageByNative();
};
