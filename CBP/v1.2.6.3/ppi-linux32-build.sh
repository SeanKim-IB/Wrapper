...
cp    LibDeviceParallel/jni/lib/libDeviceParallel.so.stripped install/libDeviceParallel.so
cp    LibDeviceParallel/jni/lib/libDeviceParallel.so.stripped lib/libDeviceParallel.so
if [ -e "/usr/lib/libDeviceParallel.so" ]
then
    echo "Found 'libDeviceParallel.so' from /usr/lib folder"
    sudo cp   LibDeviceParallel/jni/lib/libDeviceParallel.so.stripped /usr/lib/libDeviceParallel.so
else
    sudo cp   LibDeviceParallel/jni/lib/libDeviceParallel.so.stripped /usr/lib/libDeviceParallel.so
fi
