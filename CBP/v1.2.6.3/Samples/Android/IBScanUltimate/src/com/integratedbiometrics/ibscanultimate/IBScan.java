...
public class IBScan
{
    ...
    public static final class DeviceDesc
    {
        ...
        protected DeviceDesc(final String serialNumber, final String productName,
            ...
            final String devRevision, final boolean isOpened, final int deviceId)
        {
    ...
    public static boolean isScanDevice(final UsbDevice device)
    {
	    ...
	    if (vendorId == VID_IB)
	    {
	        int[] productIds = { PID_CURVE, PID_WATSON, PID_WATSON_REV1, PID_SHERLOCK, PID_SHERLOCK_REV1, 
	        		PID_WATSON_MINI, PID_WATSON_MINI_REV1, PID_COLUMBO, PID_COLUMBO_REV1, PID_KOJAK, PID_KOJAK_REV1, 
	        		PID_HOLMES, PID_FIVE0, PID_FIVE0_REV1};
    ...
    private static final int PID_SHERLOCK_REV1      = 0x1011;
